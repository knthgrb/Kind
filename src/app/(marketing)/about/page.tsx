        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Find the{" "}
                  <span
                    className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-500"
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                  We connect families with verified, trustworthy household help
                  through our rigorous verification process. From yayas to
                  skilled labor, we ensure your family receives professional
                  care every time.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/find-work"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  Search Jobs
                  <svg
            ...
            <div className="relative">
              ...
              {/* Floating Cards */}
              <div className="absolute -top-4 -left-4 bg-white rounded-2xl p-6 shadow-xl">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              through innovative technology, unwavering trust, and genuine human
              connections.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-10 rounded-3xl shadow-2xl border border-gray-100">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                  ...
                  creating a safe, transparent, and respectful marketplace that
                  benefits both families (kindBossing) and service providers
                  (kindTao). We're building bridges of trust in every home, one
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-10 rounded-3xl shadow-2xl border border-gray-100">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                  Building a community grounded in mutual trust, kindness, and
                  fair employment practices. By simplifying the hiring process,
                  we foster positive relationships, empower workers, and provide
                  peace of mind to every family we serve across the Philippines.
                </p>
                <div className="flex items-center text-red-600 font-semibold">
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-2">5,000+</h4>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              we create for both families and helpers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-red-100 to-red-200 rounded-2xl flex items-center justify-center text-red-600 mb-6 group-hover:scale-110 transition-transform duration-300">
                  {value.icon}
                </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to know about Kind and how we're transforming
              household employment in the Philippines.
            </p>
          </div>
