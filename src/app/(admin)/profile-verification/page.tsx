...
import { ProfileVerificationService } from "@/services/server/ProfileVerificationService";
import {
  approveDocument,
  rejectDocument,
} from "./_actions/verificationActions";
...
export default async function ProfileVerification() {
  ...
  const { data: users, error } =
    await ProfileVerificationService.getAllUsersWithDocuments();
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="border border-[#D9E0E8] rounded-lg px-8 py-6 bg-white">
            <div className="text-center text-gray-600">
              No users with uploaded documents found. Users need to upload
              documents to appear here.
            </div>
          </div>
        </div>
      </div>
